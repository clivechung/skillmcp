...
def test_cli_validate_success(tmp_path: Path):
    """Verifies that skill-mcp validate succeeds on valid skill directories."""
...
def test_cli_validate_failure_on_invalid_frontmatter(tmp_path: Path):
    """Verifies that skill-mcp validate flags malformed frontmatter."""
...
def test_cli_list_command(tmp_path: Path):
    """Verifies that skill-mcp list displays table of discovered skills."""
